...
- `apostilas/`
  - Modulo 1 - Fundamentos de IoT e Sistemas Embarcados (PDF)
...
Todas as apostilas estao em `apostilas/` e seguem a ordem do curso:

1. Modulo 1 - Fundamentos de IoT e Sistemas Embarcados
2. Modulo 2 - Arquitetura, Configuracao e Utilizacao Avancada de Perifericos do iMCP HTNB32L
...
3. Configuracao e uso do GPIO no HTNB32L
4. Configuracao e uso do UART no HTNB32L
...
O HTNB32L-XXX e um SiP NB-IoT ultracompacto baseado no modem Qualcomm QCX-212, compativel com 3GPP Release 14 Cat NB2. Mais detalhes e SDK em `https://github.com/htmicron/htnb32l-xxx`.

## Licenca

Consulte `LICENSE` e os avisos de direitos autorais dos PDFs e videos antes de redistribuir.

## Autor

Material organizado por Vinicius Vasconcelos para uso em estudos do modulo HTNB32L.
